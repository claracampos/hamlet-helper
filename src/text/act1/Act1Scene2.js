...
const Act1Scene2 = () => (
  <div>
    ...
    <p className="word-split">To be contracted in one brow of woe;</p>
    <p className="word-split">Yet so far hath discretion fought with nature</p>
    ...
    <p className="word-split">Now for ourself and for this time of meeting:</p>
    ...
    <p className="word-split">You, good Cornelius, and you, Voltemand,</p>
    <p className="word-split">For bearers of this greeting to old Norway,</p>
    <p className="word-split">Giving to you no further personal power</p>
    <p className="word-split">To business with the King, more than the scope</p>
    <p className="word-split">Of these dilated articles allow.</p>
    <p className="word-split">
    ...
    <p className="character-name">KING.</p>
    <p className="word-split">We doubt it nothing: heartily farewell.</p>
    ...
    <p className="word-split">That shall not be my offer, not thy asking?</p>
    <p className="word-split">The head is not more native to the heart,</p>
    <p className="word-split">The hand more instrumental to the mouth,</p>
    <p className="word-split">Than is the throne of Denmark to thy father.</p>
    <p className="word-split">What wouldst thou have, Laertes?</p>

    <p className="character-name">LAERTES.</p>
    <p className="word-split">Dread my lord,</p>
    <p className="word-split">Your leave and favour to return to France,</p>
    <p className="word-split">From whence though willingly I came to Denmark</p>
    <p className="word-split">To show my duty in your coronation;</p>
    <p className="word-split">Yet now I must confess, that duty done,</p>
    <p className="word-split">
    ...
    <p className="character-name">HAMLET.</p>
    <p className="word-split">Ay, madam, it is common.</p>

    <p className="character-name">QUEEN.</p>
    <p className="word-split">If it be,</p>
    <p className="word-split">Why seems it so particular with thee?</p>
    ...
    <p className="word-split">That can denote me truly. These indeed seem,</p>
    <p className="word-split">For they are actions that a man might play;</p>
    <p className="word-split">But I have that within which passeth show;</p>
    <p className="word-split">These but the trappings and the suits of woe.</p>
    ...
    <p className="word-split">You are the most immediate to our throne,</p>
    <p className="word-split">And with no less nobility of love</p>
    <p className="word-split">Than that which dearest father bears his son</p>
    <p className="word-split">Do I impart toward you. For your intent</p>
    <p className="word-split">In going back to school in Wittenberg,</p>
    <p className="word-split">It is most retrograde to our desire:</p>
    <p className="word-split">And we beseech you bend you to remain</p>
    <p className="word-split">Here in the cheer and comfort of our eye,</p>
    <p className="word-split">Our chiefest courtier, cousin, and our son.</p>

    <p className="character-name">QUEEN.</p>
    <p className="word-split">Let not thy mother lose her prayers, Hamlet.</p>
    <p className="word-split">
    ...
    <p className="word-split">That he might not beteem the winds of heaven</p>
    ...
    <p className="word-split">Had left the flushing in her galled eyes,</p>
    <p className="word-split">She married. O most wicked speed, to post</p>
    <p className="word-split">With such dexterity to incestuous sheets!</p>
    <p className="word-split">It is not, nor it cannot come to good.</p>
    <p className="word-split">But break my heart, for I must hold my tongue.</p>

    <p className="stage-direction">[Enter Horatio, Marcellus and Barnardo.]</p>

    <p className="character-name">HORATIO.</p>
    <p className="word-split">Hail to your lordship!</p>

    <p className="character-name">HAMLET.</p>
    <p className="word-split">I am glad to see you well:</p>
    <p className="word-split">Horatio, or I do forget myself.</p>

    <p className="character-name">HORATIO.</p>
    <p className="word-split">The same, my lord,</p>
    <p className="word-split">And your poor servant ever.</p>
    ...
    <p className="word-split">My good lord.</p>
    ...
    <p className="character-name">HORATIO.</p>
    <p className="word-split">A truant disposition, good my lord.</p>

    <p className="character-name">HAMLET.</p>
    <p className="word-split">I would not hear your enemy say so;</p>
    <p className="word-split">Nor shall you do my ear that violence,</p>
    ...
    <p className="character-name">HAMLET.</p>
    <p className="word-split">He was a man, take him for all in all,</p>
    <p className="word-split">I shall not look upon his like again.</p>

    <p className="character-name">HORATIO.</p>
    <p className="word-split">My lord, I think I saw him yesternight.</p>

    <p className="character-name">HAMLET.</p>
    <p className="word-split">Saw? Who?</p>

    <p className="character-name">HORATIO.</p>
    <p className="word-split">My lord, the King your father.</p>

    <p className="character-name">HAMLET.</p>
    <p className="word-split">The King my father!</p>

    <p className="character-name">HORATIO.</p>
    <p className="word-split">Season your admiration for a while</p>
    <p className="word-split">With an attent ear, till I may deliver</p>
    <p className="word-split">Upon the witness of these gentlemen</p>
    ...
    <p className="word-split">In dreadful secrecy impart they did,</p>
    <p className="word-split">
    ...
    <p className="word-split">The apparition comes. I knew your father;</p>
    <p className="word-split">These hands are not more like.</p>

    <p className="character-name">HAMLET.</p>
    <p className="word-split">But where was this?</p>

    <p className="character-name">MARCELLUS.</p>
    <p className="word-split">My lord, upon the platform where we watch.</p>

    <p className="character-name">HAMLET.</p>
    <p className="word-split">Did you not speak to it?</p>

    <p className="character-name">HORATIO.</p>
    <p className="word-split">My lord, I did;</p>
    <p className="word-split">But answer made it none: yet once methought</p>
    <p className="word-split">It lifted up it head, and did address</p>
    ...
    <p className="character-name">HAMLET.</p>
    <p className="word-split">Indeed, indeed, sirs, but this troubles me.</p>
    <p className="word-split">Hold you the watch tonight?</p>
    ...
    <p className="character-name">BOTH.</p>
    <p className="word-split">My lord, from head to foot.</p>

    <p className="character-name">HAMLET.</p>
    <p className="word-split">Then saw you not his face?</p>
    ...
    <p className="character-name">HAMLET.</p>
    <p className="word-split">Pale, or red?</p>
    ...
    <p className="character-name">HAMLET.</p>
    <p className="word-split">Your loves, as mine to you: farewell.</p>
